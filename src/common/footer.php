<footer class="flex w-full bg-tblue2 justify-center border-t-4 border-tblue3 bottom-0 text-twhite font-semibold p-2">
  <div class="flex flex-col md:flex-row text-center md:text-left text-sm md:text-md justify-between max-w-6xl w-full px-6">
    <div>TimeWarp Consoles v6 &copy; 2024 Ethan Cooke</div>
    <span id="time"></span>
  </div>
</footer>
