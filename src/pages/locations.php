  ...
  <div class="flex flex-col w-full min-h-screen">
    ...
    <div class="flex justify-center flex-grow">
      <div class="flex flex-col w-full max-w-6xl gap-6 text-tgray p-6">
        ...
        <div class="flex flex-col md:flex-row gap-4 bg-tblue1 md:rounded-full rounded-md overflow-hidden">
          <img class="location-image" src="images/location1.png" alt="location 1">
          <div class="p-2 justify-center flex flex-col prose max-w-none">
            <h2>Dartmouth</h2>
