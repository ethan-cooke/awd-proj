      ...
      <div class="flex justify-center">
        <div class="columns-xs justify-center max-w-6xl w-full p-6 gap-6">
          ...
          <div class="flex flex-col p-4 gap-4 break-inside-avoid mb-3 bg-stone-300 rounded-md text-center">
            ...
            <a class="text-xl font-bold" href="pages/sorry.php">Create Account</a>
            <a class="text-xl font-bold" href="pages/sorry.php">Catalog</a>
            <a class="text-xl font-bold" href="pages/sorry.php">Log In</a>
          </div>
          <div class="flex flex-col p-4 gap-4 break-inside-avoid mb-3 bg-stone-300 rounded-md text-center">
            <div class="text-2xl font-bold">About Us</div>
            <a class="text-xl font-bold" href="pages/sorry.php">Our Story</a>
            ...
            <a class="text-xl font-bold" href="pages/sorry.php">Feedback Form</a>
          </div>
        </div>
      </div>
    </div>
