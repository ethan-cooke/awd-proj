      ...
      <div class="flex w-full max-w-6xl">
        <div class="flex flex-col w-full prose max-w-none text-neutral-600 p-6">
          ...
          <div class="flex flex-col w-full bg-slate-200 rounded-lg p-4 gap-4">
            ...
            <div class="flex flex-col gap-4 border-b items-stretch border-slate-300 pb-4">
              <?php include "../scripts/get_cart.php" ?>
              <div class="grid grid-cols-3">
                <div class="grid-item font-bold">Name</div>
                <div class="grid-item font-bold">Quantity</div>
                <div class="grid-item font-bold">Price</div>
                <?php foreach($products as $product): ?>
                <div class="grid-item"><?= $product["name"] ?></div>
                <div class="grid-item"><?= $product["quantity"] ?></div>
